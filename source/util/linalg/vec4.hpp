...
struct tvecn<T,4> {
    ...
    inline tvecn(T ax, T ay, T az, T aw) {
		this->data[0] = ax;
		this->data[1] = ay;
		this->data[2] = az;
		this->data[3] = aw;
	...
	inline T x() const {return this->data[0];}
	inline T y() const {return this->data[1];}
	inline T z() const {return this->data[2];}
	inline T w() const {return this->data[3];}
};
